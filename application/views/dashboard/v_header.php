			...
			<section class="sidebar">
				<div class="user-panel">
					...
					<div class="pull-left info">
						...
						?>
						<p><?php echo $user->pengguna_nip; ?></p>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li>
						<a href="<?php $val = "30"; echo base_url().'dashboard/kategori/'.$val?>">
							<i class="fa fa-th"></i>
							<span>KINERJA 30%</span>
						</a>
					</li>
					<li>
						<a href="<?php $val = "70"; echo base_url().'dashboard/artikel/'.$val?>">
							<i class="fa fa-pencil"></i>
							<span>KINERJA 70%</span>
						</a>
					</li>
